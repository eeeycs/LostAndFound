 ...
 */
@Entity
@Table(name = "studentinfo", catalog = "studentinfo")
public class StudentInfo implements java.io.Serializable {
	...
	private String pwd;
	private Integer ybinfo;
	private Integer ybregister;
	...
	public StudentInfo(Integer id, String selectId, String examId,
			String studyId, String name, String sex, String img, String xibie,
			String zhuanye, String xuezi, String peiyangcengci, String nianji,
			String banji, String xinzhuanye, String xinbanji,
			String xuejizhuangtai, String ruxueriqi, String shenfenzhenghaoma,
			...
			Integer ybinfo, Integer ybregister) {
		super();
		this.id = id;
	...
	@Column(name = "ybinfo")
	public Integer getYbinfo() {
		return this.ybinfo;
	}

	public void setYbinfo(Integer ybinfo) {
		this.ybinfo = ybinfo;
	}

	@Column(name = "ybregister")
	public Integer getYbregister() {
		return this.ybregister;
	}

	public void setYbregister(Integer ybregister) {
		this.ybregister = ybregister;
	}
	...
	public String toString() {
		return String
				.format("Studentinfo [id=%s, selectId=%s, examId=%s, studyId=%s, name=%s, sex=%s, img=%s, xibie=%s, zhuanye=%s, xuezi=%s, peiyangcengci=%s, nianji=%s, banji=%s, xinzhuanye=%s, xinbanji=%s, xuejizhuangtai=%s, ruxueriqi=%s, shenfenzhenghaoma=%s, chushengnianyueri=%s, minzu=%s, zhengzhimianmao=%s, address=%s, huochezhandian=%s, fumuxingming=%s, gerendianhua=%s, jiatingdianhua=%s, techang=%s, shifoubenrenzhaopian=%s, suodingxinxi=%s, pwd=%s, ybinfo=%s, ybregister=%s]",
						...
						shifoubenrenzhaopian, suodingxinxi, pwd, ybinfo,
						ybregister);
	}
